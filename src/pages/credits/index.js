    ...
    <div className='container'>
      ...
      <div className='main-body'>
        ...
        <div className='options'>
          <button className='menu'><a href='../../App.js'>Main menu</a></button>
          <button className='play'><a href='../select-difficulty'>Play a game</a></button>
          <button className='board'><a href='../leaderboard'>Leaderboard</a></button>
        </div>
